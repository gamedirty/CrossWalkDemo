...
package com.lsh123.zxing.integration.android;
...
import com.lsh123.zxing.client.android.Intents;
...
public class IntentIntegrator {
     ...
     * else an {@link com.lsh123.zxing.integration.android.IntentResult} containing the result of the scan. If the user cancelled scanning,
     * the fields will be null.
     */
    public static com.lsh123.zxing.integration.android.IntentResult parseActivityResult(int requestCode, int resultCode, Intent intent) {
        if (requestCode == REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                return new com.lsh123.zxing.integration.android.IntentResult(contents,
                        formatName,
                        rawBytes,
                        orientation,

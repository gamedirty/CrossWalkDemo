...
import com.lsh123.zxing.client.android.DecodeFormatManager;
import com.lsh123.zxing.client.android.DecodeHintManager;
    ...
    private void initialize(AttributeSet attrs) {
        ...
        if (barcodeView == null) {
            throw new IllegalArgumentException(
                "There is no a com.lsh123.zxing.BarcodeView on provided layout " +
        ...
        if (viewFinder == null) {
            throw new IllegalArgumentException(
                "There is no a com.lsh123.zxing.ViewfinderView on provided layout " +

...
import com.elianshang.photoview.PhotoView;
import com.elianshang.photoview.PhotoViewAttacher;
...
public class PhotoPagerAdapter extends PagerAdapter {
  ...
  @Override public Object instantiateItem(ViewGroup container, int position) {
    ...
    ImageCacheMannager.loadImage(imageView.getContext(), uri, R.mipmap.default_error, R.mipmap.default_error, imageView);
